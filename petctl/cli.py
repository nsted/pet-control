...
def run(
    ...
    control: str = typer.Option(
        ...
        help=(
            ...
            "stroke, stroke-curl, curl-towards, curl-away, stroke-snuggle, "
    ...
    if control == "keyboard":
    ...
    elif control in ("snuggle", "pulse", "breathe", "sway", "cascade", "slalom", "twitch", "freeze", "coil", "curl", "spin7", "stroke", "stroke-curl", "curl-towards", "curl-away", "stroke-snuggle", "explore", "seek-touch", "avoid-touch", "drift", "struggle", "neighbor-assist-drift", "yield-stiff", "pose", "balanced-torque", "purr-ripple"):
        ...
        typer.echo(
            ...
            "Choose: keyboard, passthrough, sine, command, ollama, snuggle, pulse, breathe, sway, cascade, slalom, twitch, freeze, coil, curl, spin7, stroke, stroke-curl, curl-towards, curl-away, stroke-snuggle, explore, seek-touch, avoid-touch, drift, struggle, neighbor-assist-drift, yield-stiff, pose, balanced-torque, purr-ripple",
            err=True,
        )
        raise typer.Exit(1)
