...
def run(
    ...
    if control == "keyboard":
    ...
    elif control in ("snuggle", "pulse", "breathe", "sway", "cascade", "slalom", "twitch", "freeze", "coil", "curl", "spin7", "stroke", "stroke-curl", "curl-towards", "curl-away", "stroke-snuggle", "explore", "seek-touch", "avoid-touch", "drift", "struggle", "neighbor-assist-drift", "yield-stiff", "pose"):
        ...
        typer.echo(
            ...
            "Choose: keyboard, passthrough, sine, command, ollama, snuggle, pulse, breathe, sway, cascade, slalom, twitch, freeze, coil, curl, spin7, stroke, stroke-curl, curl-towards, curl-away, stroke-snuggle, explore, seek-touch, avoid-touch, drift, struggle, neighbor-assist-drift, yield-stiff, pose",
            err=True,
        )
        raise typer.Exit(1)
