...
def run(
    ...
    control: str = typer.Option(
        ...
        help=(
            ...
            "ripple, pulse, breathe, sway, cascade, slalom, twitch, freeze, coil, stroke"
        ),
    ),
    ...
    if control == "keyboard":
    ...
    elif control in ("ripple", "pulse", "breathe", "sway", "cascade", "slalom", "twitch", "freeze", "coil", "curl", "spin7", "stroke"):
        ...
        typer.echo(
            ...
            "Choose: keyboard, passthrough, sine, ripple, pulse, breathe, sway, cascade, slalom, twitch, freeze, coil, curl, spin7, stroke",
            err=True,
        )
        raise typer.Exit(1)
